...
class Game:
    ...
    def setup(self):
        ...
        self.sensor = ObjectSensor(self.ego_car, measurement_noise=5)
    ...
    def draw_all(self):
        ...
        pygame.draw.line(self.SCREEN, (255,0,0), self.ego_car.position,
                         self.sensor.last_position + self.sensor.last_velocity,
                         2)
        pygame.draw.line(self.SCREEN, (0, 0, 255), self.ego_car.position,
                         self.sensor.last_position + self.sensor.last_acceleration,
                         2)


    def loop(self):
        print("Starting Main Loop")
        pygame.key.set_repeat(200, math.floor(2/self.freq))
        while True:
            # Event Detection
            ...
            if time.time() - self.last_refresh_time > 1./self.freq:
